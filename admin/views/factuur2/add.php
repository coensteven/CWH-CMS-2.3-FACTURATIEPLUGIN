...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            Klant  <small>toevoegen</small>
        </h3>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Factuur2_New" id="frm_Factuur2_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
            <div class="row pad">
                <div class="col-md-12" id="col-md-12">
                    ...
                    <?php echo Pf::event()->trigger("filter","factuur2-form"); ?>
                    <?php echo Pf::event()->trigger("filter","factuur2-adding-form"); ?>
                </div>
            </div>
        </form>
    </div>
...
function Factuur2_New(){
	$("#main-content").mask("<?php echo __('Loading...','testimonials'); ?>");
	try{
	   tinymce.triggerSave(); 
        tinymce.remove();
    }catch(e){}
	$.post($('#frm_Factuur2_New').attr('action'),$('#frm_Factuur2_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
